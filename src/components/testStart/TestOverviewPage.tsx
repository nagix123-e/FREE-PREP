...
export function TestOverviewPage() {
  ...
  return (
    <section className="safe-card-padding-lg mx-auto max-w-4xl rounded-md border border-line bg-white p-8 shadow-panel">
      ...
      <button className="mt-6 rounded-md bg-teal-700 px-5 py-3 text-sm font-semibold text-white" onClick={() => navigate("rulesAndTools", selectedSetId ?? undefined)} type="button">
        Continue
      </button>
    </section>
  );
